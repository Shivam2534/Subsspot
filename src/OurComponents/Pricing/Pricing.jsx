...
const Button = ({ children, variant, size, className, ...props }) => (
  <button
    className={`${className} ${variant === "ghost" ? "bg-transparent" : ""} ${
      ...
      <main className="flex-grow">
        <section className="py-12 sm:py-20 px-4 text-center bg-gradient-to-b from-[#282828] to-black">
          ...
          <p className="text-lg sm:text-xl mb-8 max-w-2xl mx-auto">
            Enjoy YouTube Premium at a fraction of the cost with our monthly
            plan.
          </p>
        </section>
        ...
        <section className="py-12 sm:py-20 px-4 bg-black">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl sm:text-3xl font-bold text-center mb-12">
              Compare Subspot vs. YouTube Premium
            </h2>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-gray-700">
                    ...
                    <th className="py-4 px-6 bg-[#282828] text-center">
                      Subspot Monthly
                    </th>
                    <th className="py-4 px-6 bg-[#282828] text-center">
